...
export default function Login() {
  ...
  return (
    <Box sx={{ flexFlow: 1}}>
      <Head>
        <title>Inicio de sesión | Smart Report</title>
          ...
          <form onSubmit={onSubmit}>
            <Box width={largeScreen ? 450 : '100%'} p={2}>
              ...
              <Box  mt={5} display='flex' justifyContent='center'>
                <Button type='submit' disabled={loading} variant='contained' color='secondary'>{loading ? 'Iniciando sesión...' : 'Iniciar sesión'}</Button>
              </Box>
            </Box>
          </form>
        </Box>
